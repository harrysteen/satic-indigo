...
export default function Footer() {
  return (
    <footer
      className="relative w-full text-brand-white pt-24 pb-8 overflow-hidden font-sans border-t border-brand-white/10 bg-cover bg-center"
      style={{ backgroundImage: 'url("/kumar-images/signatur-dining.png")' }}
    >
      {/* Corner Decorations */}
      <WhitePetals position="bottom-left" className="bottom-[-4px] left-[-4px]" opacity="opacity-100" />
      <WhitePetals position="bottom-right" className="bottom-[-4px] right-[-4px]" opacity="opacity-100" />
