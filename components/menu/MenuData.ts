...
export const MENU_DATA: Record<string, MenuItem[]> = {
  ...
  "MAIN COURSE": [
    { id: "ma77", name: "Aloo Gobi", description: "A classic vegan dish featuring a dry, spiced curry made with potatoes and cauliflower.", price: "12.99", category: "MAIN COURSE" },
    { id: "ma78", name: "Bhindi Masala", description: "Okra cooked with onions and tomatoes in a spiced, flavorful sauce.", price: "12.99", category: "MAIN COURSE" },
    { id: "ma79", name: "Chana Masala", description: "Chickpeas cooked with onions and tomatoes in a flavorful spiced gravy.", price: "11.99", category: "MAIN COURSE" },
    { id: "ma80", name: "Dal Makhni", description: "Kidney beans and whole urad slow-cooked in butter and cream with aromatic spices.", price: "12.99", category: "MAIN COURSE" },
    { id: "ma81", name: "Dal Tadka", description: "Yellow lentils cooked with onions and tomatoes in a flavorful spiced gravy.", price: "11.99", category: "MAIN COURSE" },
    { id: "ma82", name: "Soya Kaai Makhhan", description: "Soya chaap cooked in a rich, buttery tomato sauce.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma83", name: "Malai Kofta Lajaj", description: "Soft vegetable dumplings simmered in a rich, creamy milk-based gravy.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma84", name: "Palak Paneer", description: "Soft paneer cubes simmered in a creamy spinach sauce with fenugreek and aromatic spices.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma85", name: "Paneer Tikka Masala", description: "Grilled cottage cheese simmered in a creamy tomato-based sauce with onions and bell peppers.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma86", name: "Paneer Makhni", description: "Cottage cheese cubes cooked in a rich tomato and onion cream gravy.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma87", name: "Paneer Bhurji", description: "Crumbled cottage cheese cooked with onions, tomatoes, green chilies, ginger, and garlic.", price: "14.99", category: "MAIN COURSE" },
  ...
  "NON-VEG CURRIES": [
    { id: "no92", name: "Butter Chicken", description: "Tender boneless BBQ chicken in a creamy tomato-butter sauce.", price: "15.99", category: "NON-VEG CURRIES" , image: "/imges/menu/indigo_s menu/butter chicken4.webp" },
    { id: "no93", name: "Chicken egg Masala", description: "A rich and flavorful curry made with chicken and boiled eggs.", price: "15.99", category: "NON-VEG CURRIES" },
    { id: "no94", name: "Chicken Korma", description: "Tender chicken marinated in yogurt and slow cooked with onions and aromatic spices.", price: "15.99", category: "NON-VEG CURRIES" , image: "/imges/menu/indigo_s menu/chicken korma3.webp" },
    { id: "no95", name: "Goat Kali Mirch", description: "Bone-in goat cooked in a peppery, spiced gravy.", price: "19.99", category: "NON-VEG CURRIES" , image: "/imges/menu/indigo_s menu/goat kalimirch4.webp" },
    { id: "no96", name: "Goat Korma", description: "Bone-in goat cooked with onions and yogurt in a lightly spiced brown gravy.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no97", name: "Hyderabadi Goat Curry", description: "Bone-in goat simmered in a rich brown curry with onions, coconut, and yogurt.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no98", name: "Murgh Tikka Masala", description: "Grilled BBQ chicken simmered in a creamy tomato-based sauce with onions and bell peppers.", price: "15.99", category: "NON-VEG CURRIES" },
    { id: "no99", name: "Indigo Kebab Fry", description: "A signature dish featuring fried kebabs in a spiced gravy.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no100", name: "Chicken Handi", description: "Whole bone-in chicken pieces slow-cooked with onions, yogurt, and traditional spices.", price: "15.99", category: "NON-VEG CURRIES" },
    { id: "no101", name: "Peshawari Chicken Karahi", description: "Mixed bone-in chicken cooked with onion, green onions, cream, and yogurt.", price: "15.99", category: "NON-VEG CURRIES" },
    { id: "no102", name: "Goat Paya", description: "Slow-cooked goat trotters in a rich, spicy broth.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no103", name: "Bombay Kheema Matar", description: "Minced meat cooked with green peas and aromatic spices.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no104", name: "Peshawari Goat Karahi", description: "Bone-in goat cooked in a traditional wok with tomatoes, green chilies, and spices.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no105", name: "Egg Curry", description: "Boiled eggs cooked in a flavorful spiced gravy.", price: "12.99", category: "NON-VEG CURRIES" },
    { id: "no106", name: "Indigo Chicken Karahi", description: "A signature chicken curry cooked in a traditional wok.", price: "15.99", category: "NON-VEG CURRIES" },
    { id: "no107", name: "Hyderabadi Tala Gosht", description: "Fried goat meat seasoned with traditional Hyderabadi spices.", price: "19.99", category: "NON-VEG CURRIES" },
    { id: "no108", name: "Egg Bhurji", description: "Spiced scrambled eggs cooked with onions, tomatoes, and green chilies.", price: "12.99", category: "NON-VEG CURRIES" }
  ],
  "RICE": [
    { id: "ri109", name: "Chicken Biryani", description: "Aromatic basmati rice cooked with marinated chicken and traditional spices.", price: "14.99", category: "RICE" , image: "/imges/menu/indigo_s menu/chicken biryani5 (1).webp" },
    { id: "ri110", name: "Goat Biryani", description: "Aromatic basmati rice cooked with marinated goat meat and traditional spices.", price: "17.99", category: "RICE" , image: "/imges/menu/indigo_s menu/goat biryani4.webp" },
    { id: "ri111", name: "Jeera Rice", description: "Basmati rice flavored with cumin seeds.", price: "4.99", category: "RICE" },
    { id: "ri112", name: "Vegetable Biryani", description: "Aromatic basmati rice cooked with mixed vegetables and traditional spices.", price: "12.99", category: "RICE" },
    { id: "ri113", name: "Plain Rice", description: "Steamed basmati white rice.", price: "3.99", category: "RICE" }
  ],
  "SEAFOOD SPECIALITIES": [
    ...
    { id: "se116", name: "Shrimp Masala", description: "Shrimp cooked with onions, tomatoes, garlic, ginger, and bold spices.", price: "16.99", category: "SEAFOOD SPECIALITIES" }
  ],
  "SOUPS": [
    { id: "so117", name: "Chicken Corn Soup", description: "Smooth and creamy soup made with chicken, sweet corn, and aromatic spices.", price: "5.99", category: "SOUPS" },
