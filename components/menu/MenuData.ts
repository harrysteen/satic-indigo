...
export const MENU_DATA: Record<string, MenuItem[]> = {
  "APPETIZERS": [
    ...
    { id: "ap2", name: "Chicken Samosa", description: "Crispy pastry filled with spiced minced chicken, served with mint and tamarind chutney.", price: "6.99", category: "APPETIZERS" },
    ...
    { id: "ap5", name: "Chili Chicken Dry", description: "Indo-Chinese style spicy fried chicken with green chilies, onions, and bell pepper.", price: "10.99", category: "APPETIZERS" },
    { id: "ap6", name: "Bang Bang Shrimp", description: "Crispy fried shrimp tossed in a creamy, tangy, and spicy house sauce.", price: "10.90", category: "APPETIZERS" },
    { id: "ap7", name: "Chicken 65 Dry", description: "Spicy, deep-fried chicken bites marinated with South Indian spices and curry leaves.", price: "10.99", category: "APPETIZERS" },
    { id: "ap8", name: "Chicken Lollipop", description: "Juicy chicken wings, marinated in spices, deep-fried, and served with a flavorful dip.", price: "14.99", category: "APPETIZERS" , image: "/imges/menu/indigo_s menu/chicken lollipops7.webp" },
    ...
    { id: "ap12", name: "Dry Chili Paneer", description: "Stir-fried cubes of cottage cheese with bell peppers and onions in a spicy chili sauce.", price: "13.99", category: "APPETIZERS" , image: "/imges/menu/indigo_s menu/chicken paneer.webp" },
  ...
  "BARBECUE STARTERS": [
    { id: "ba14", name: "Chicken Seekh Kebab", description: "Minced chicken blended with aromatic herbs and spices, grilled on skewers.", price: "13.99", category: "BARBECUE STARTERS" },
    { id: "ba15", name: "Murgh Malai Boti", description: "Succulent chicken pieces marinated in cream, hung curd, and cardamom, grilled to perfection.", price: "13.99", category: "BARBECUE STARTERS" },
    { id: "ba16", name: "Paneer Tikka Nawab", description: "Soft cubes of cottage cheese marinated in a rich blend of spices and grilled in tandoor.", price: "12.99", category: "BARBECUE STARTERS" },
    { id: "ba17", name: "Tandoori Lamb Chops", description: "Juicy lamb chops marinated overnight in raw papaya and secret spices, char-grilled.", price: "13.99", category: "BARBECUE STARTERS" },
    { id: "ba18", name: "Goat Seekh Kebab", description: "Flavorful minced goat meat mixed with spices and herbs, grilled on skewers.", price: "13.99", category: "BARBECUE STARTERS" , image: "/imges/menu/indigo_s menu/goat sheekh kabob4.webp" },
    { id: "ba19", name: "Tandoori Chicken", description: "Bone-in chicken marinated in yogurt and traditional tandoori spices, roasted in clay oven.", price: "9.99", category: "BARBECUE STARTERS" },
    { id: "ba20", name: "Chicken Boti", description: "Tender boneless chicken chunks marinated in Indian spices and grilled to perfection.", price: "10.99", category: "BARBECUE STARTERS" , image: "/imges/menu/indigo_s menu/chicken boti.webp" },
    { id: "ba21", name: "Indigo Mix Grill Platter", description: "A grand platter featuring Chicken Bihari, Chicken Seekh, and Goat Seekh Kebabs.", price: "29.99", category: "BARBECUE STARTERS" }
  ],
  "BREAD": [
    { id: "br22", name: "Plain Naan", description: "Soft and fluffy traditional Indian flatbread baked in a clay oven.", price: "1.99", category: "BREAD" },
    ...
    { id: "br24", name: "Garlic Naan", description: "Naan bread topped with minced garlic, cilantro, and butter.", price: "3.99", category: "BREAD" },
    { id: "br25", name: "Chili Naan", description: "Spicy naan bread topped with green chilies, cilantro, and butter.", price: "3.99", category: "BREAD" },
    { id: "br26", name: "Cheese Naan", description: "Tandoori naan bread stuffed with melted cheese and glazed with butter.", price: "4.99", category: "BREAD" },
    ...
    { id: "br28", name: "Roti", description: "Traditional whole wheat flatbread baked in a clay oven.", price: "0.99", category: "BREAD" },
  ...
  "CHAAT": [
    ...
    { id: "ch31", name: "Kachori Chaat", description: "Savory fried pastry crushed and topped with chickpeas, yogurt, and assorted chutneys.", price: "8.99", category: "CHAAT" },
    { id: "ch32", name: "Pani Puri", description: "Crispy hollow puris served with spiced potatoes, chickpeas, and tangy-spicy flavored water.", price: "7.99", category: "CHAAT" },
    ...
    { id: "ch34", name: "Samosa Chaat", description: "Crushed samosas topped with spicy chickpea curry, yogurt, and traditional chutneys.", price: "8.99", category: "CHAAT" },
  ...
  "DESSERT": [
    { id: "de36", name: "Carrot Halwa with Gulab Jamun", description: "Warm carrot pudding paired with soft milk-solid dumplings in sugar syrup.", price: "4.99", category: "DESSERT" , image: "/imges/menu/indigo_s menu/carrot halva3.webp" },
    ...
    { id: "de39", name: "Rasmalai shot", description: "Delicate cheese dumplings soaked in saffron-infused sweetened milk.", price: "4.99", category: "DESSERT" , image: "/imges/menu/indigo_s menu/rabdi shot2.webp" }
  ],
  "DRINKS - NON ALCOHOLIC": [
    ...
    { id: "dr48", name: "Regular Ice Tea", description: "", price: "1.99", category: "DRINKS - NON ALCOHOLIC" },
    { id: "dr49", name: "Lemon Ice Tea", description: "", price: "1.99", category: "DRINKS - NON ALCOHOLIC" },
    ...
    { id: "dr54", name: "Mojito", description: "Refreshing drink with mint and soda, served chilled.", price: "4.99", category: "DRINKS - NON ALCOHOLIC" },
    { id: "dr55", name: "Chai", description: "Hot tea made with cow’s milk, served warm.", price: "2.99", category: "DRINKS - NON ALCOHOLIC" , image: "/imges/menu/indigo_s menu/chai.webp" },
    { id: "dr56", name: "Thumbs Up", description: "", price: "2.99", category: "DRINKS - NON ALCOHOLIC" }
  ],
  "INDO CHINESE": [
    ...
    { id: "in59", name: "Veg Hakka Noodles", description: "Stir-fried noodles tossed with crisp vegetables and savory Asian sauces.", price: "12.99", category: "INDO CHINESE" },
    { id: "in60", name: "Veg Schezwan Fried Rice", description: "Stir-fried rice with spicy Schezwan sauce, mixed vegetables, and a hint of tangy heat.", price: "13.99", category: "INDO CHINESE" },
    { id: "in61", name: "Veg Schezwan Noodles", description: "Spicy stir-fried noodles with vegetables and bold Schezwan flavors.", price: "13.99", category: "INDO CHINESE" },
    ...
    { id: "in63", name: "Chicken Schezwan Fried Rice", description: "Stir-fried rice with spicy Schezwan sauce, mixed chicken, and a hint of tangy heat.", price: "14.99", category: "INDO CHINESE" },
    { id: "in64", name: "Chicken Hakka Noodles", description: "Stir-fried noodles tossed with crisp chicken and savory Asian sauces.", price: "13.99", category: "INDO CHINESE" },
    { id: "in65", name: "Veg Manchurian", description: "Crispy vegetable balls tossed in Manchurian sauce.", price: "13.99", category: "INDO CHINESE" },
    ...
    { id: "in67", name: "Indigo Special Triple Schezwan", description: "Fried rice, noodles, and vegetable balls tossed in a bold Schezwan sauce.", price: "14.99", category: "INDO CHINESE" },
    { id: "in68", name: "Chicken Fried Rice", description: "Stir-fried rice with a medley of fresh chicken and subtle spices.", price: "13.99", category: "INDO CHINESE" },
    { id: "in69", name: "Chicken Schezwan Noodles", description: "Spicy stir-fried noodles with chicken and bold Schezwan flavors.", price: "14.99", category: "INDO CHINESE" },
  ...
  "KIDS MENU": [
    ...
    { id: "ki73", name: "Kids Chicken Seekh Kebab", description: "Mildly spiced minced chicken grilled to perfection.", price: "5.99", category: "KIDS MENU" },
    { id: "ki74", name: "Kids Goat Seekh Kebab", description: "Mildly spiced minced goat meat grilled to perfection.", price: "5.99", category: "KIDS MENU" },
    { id: "ki75", name: "Cheese Naan Pizza with Chicken", description: "Cheese naan topped with pizza sauce and chicken.", price: "5.99", category: "KIDS MENU" },
    { id: "ki76", name: "Kids Veg Fried Rice", description: "Kid-friendly stir-fried rice with mixed vegetables.", price: "5.99", category: "KIDS MENU" }
  ],
  "MAIN COURSE": [
    ...
    { id: "ma80", name: "Dal Makhni", description: "Slow-cooked black lentils and kidney beans in a creamy, buttery tomato sauce.", price: "11.99", category: "MAIN COURSE" },
    ...
    { id: "ma82", name: "Koya Kaju Makkhan", description: "Soya chaap cooked in a luxurious and velvety butter-tomato gravy.", price: "15.99", category: "MAIN COURSE" },
    { id: "ma83", name: "Malai Kofta Laziz", description: "Soft vegetable and paneer dumplings simmered in a rich, creamy cashew-based gravy.", price: "15.99", category: "MAIN COURSE" },
    ...
    { id: "ma86", name: "Paneer Makhni", description: "Soft paneer pieces cooked in a delicate, buttery tomato cream sauce.", price: "15.99", category: "MAIN COURSE" },
    { id: "ma87", name: "Paneer Bhurji", description: "Scrambled cottage cheese cooked with fresh tomatoes, onions, and green chilies.", price: "15.99", category: "MAIN COURSE" },
    { id: "ma88", name: "Chicken 65 Gravy", description: "Tender chicken bites in a spicy and tangy gravy with curry leaves.", price: "13.99", category: "MAIN COURSE" },
    { id: "ma89", name: "Chicken Boti Roll", description: "Grilled chicken chunks wrapped in a soft paratha with onions and chutneys.", price: "11.99", category: "MAIN COURSE" },
    { id: "ma90", name: "Chicken Sheek Kabab Roll", description: "Spiced minced chicken kebabs wrapped in a paratha with fresh salad.", price: "11.99", category: "MAIN COURSE" },
  ...
  "NON-VEG CURRIES": [
    { id: "no92", name: "Butter Chicken", description: "Boneless tandoori chicken simmered in a world-famous creamy tomato and butter sauce.", price: "14.99", category: "NON-VEG CURRIES" , image: "/imges/menu/indigo_s menu/butter chicken4.webp" },
    { id: "no93", name: "Chicken Egg Masala", description: "A unique and hearty curry featuring tender chicken and whole boiled eggs.", price: "13.99", category: "NON-VEG CURRIES" },
    { id: "no94", name: "Chicken Korma", description: "Succulent chicken pieces slow-cooked in a rich yogurt and onion-based gravy.", price: "13.99", category: "NON-VEG CURRIES" , image: "/imges/menu/indigo_s menu/chicken korma3.webp" },
