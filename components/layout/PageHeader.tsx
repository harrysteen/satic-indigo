...
export default function PageHeader({ topTitle, title, subtitle }: PageHeaderProps) {
  return (
    <section className="relative w-full pt-[160px] md:pt-[200px] pb-[100px] md:pb-[140px] bg-white flex flex-col items-center overflow-hidden min-h-[40vh] md:min-h-[50vh] justify-center">
      {/* Side Decorations */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        <h1 className={`${topTitle ? 'text-3xl md:text-5xl' : 'text-3xl md:text-5xl'} text-[#20064A] font-el-messiri tracking-[0.1em] leading-tight uppercase mb-2 md:mb-3`}>
          {title}
        </h1>
        ...
        <p className="text-[#2C0074] text-[18px] font-el-messiri font-medium leading-relaxed tracking-[0.02em] max-w-3xl px-4">
          {subtitle}
        </p>
      </div>
    </section>
