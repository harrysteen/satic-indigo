  ...
  return (
    <section className="relative py-24 overflow-hidden min-h-[400px] flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 relative z-20 max-w-[1200px] text-center space-y-6">
        ...
        <h2 className="text-[24px] md:text-[32px] font-el-messiri font-semibold text-[#CF9000] leading-tight md:leading-[37.33px] tracking-normal max-w-4xl mx-auto">
        ...
        {/* Sub Quote */}
        <p className="text-[18px] md:text-[24px] font-plus-jakarta font-medium text-[#2C0074] leading-relaxed">
