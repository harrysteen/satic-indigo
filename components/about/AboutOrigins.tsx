...
const AboutOrigins = () => {
  return (
    <section className="relative bg-brand-white text-[#20074A] z-10">

      <div className="container mx-auto px-4 py-24 max-w-7xl relative z-10">
        <div className="flex flex-col items-center mb-12">
          <h2 className="text-3xl md:text-[48px] font-el-messiri text-[#20074A] mb-6 text-center leading-tight">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 lg:gap-14">
          ...
          <div className="flex-1 space-y-6 order-2 md:order-1">
            <p className="text-lg md:text-[22px] text-[#20074A] leading-relaxed font-sans font-medium">
