    ...
    <section className="relative min-h-screen bg-[#20074A] overflow-hidden flex items-center py-24">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        <div className="text-center">
          {/* Heading */}
          <h2 className="text-[32px] md:text-[48px] font-el-messiri font-bold text-[#FAFAFA] leading-tight lg:leading-[60px] tracking-[0.02em] mb-2">
            When Borders Were Not Drawn
          </h2>

          {/* Decorative Divider - Decreased space */}
          <div className="flex items-center justify-center gap-4 w-full max-w-2xl mx-auto mb-8">
          ...
          {/* Body Text */}
          <p className="max-w-5xl mx-auto text-lg md:text-[22px] font-plus-jakarta font-semibold text-[#FAFAFA] leading-relaxed md:leading-[32px] tracking-[0.02em]">
