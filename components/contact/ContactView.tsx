          ...
          <div className="max-w-[1240px] w-full flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
                  ...
                  <div className="bg-[#20064A] p-8 rounded-xl border border-[#DFAB40]/40 flex flex-col items-center justify-center text-center group transition-all hover:scale-[1.02] shadow-xl">
                      ...
                      <a href="https://maps.app.goo.gl/7ufLmiSN9jRVn4fYA" target="_blank" rel="noopener noreferrer" className="text-white text-xs md:text-sm font-medium leading-relaxed max-w-[200px] hover:text-[#DFAB40] transition-colors block mt-2">451 Mennonite Road, Suite 190, Rosenberg, TX 77469, United States</a>
                  </div>
