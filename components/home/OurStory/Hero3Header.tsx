...
export default function Hero3Header() {
  return (
    <div className="flex flex-col items-center mb-2 md:mb-4 w-full text-center font-sans">
      ...
      <div className="flex flex-col items-center gap-2 md:gap-3 w-full max-w-2xl px-4 mt-0 md:mt-2">
        ...
        <p className="text-brand-blue text-base md:text-xl font-medium tracking-wide font-serif">
